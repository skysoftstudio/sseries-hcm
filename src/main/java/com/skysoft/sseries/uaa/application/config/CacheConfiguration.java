...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("sseriesHcm");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("sseriesHcm");
        ...
        config.getMapConfigs().put("com.skysoft.sseries.uaa.application.domain.*", initializeDomainMapConfig(jHipsterProperties));
